...
export const userConfirmResetReducer = (state = {}, action) => {
  switch (action.type) {
    case USER_CONFIRM_RESET_REQUEST:
      return { loading: true};
    case USER_CONFIRM_RESET_SUCCESS:
      return { loading: false, message: action.payload };
    case USER_CONFIRM_RESET_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
